...
const Home = () => (
    <main className="container relative bg-[#fafafa]">
        <section className="hero grid h-full justify-evenly bg-cover bg-center bg-no-repeat sm:grid-cols-2 sm:py-14 lg:grid-cols-3 lg:bg-contain lg:py-20">
            ...
            <div className="flex flex-1 flex-col gap-2 py-3 text-center text-[#bb9044] sm:hidden sm:py-14 lg:py-20">
                ...
                <Button
                    className="mx-auto w-[80px] rounded-sm border border-[#bb9044] text-[#995c2a] hover:bg-[#bb9044] hover:text-[#fafafa]"
                    variant="outline">
                    Buy Now
                </Button>
            </div>
